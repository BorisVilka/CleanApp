...
public class Config {
    ...
    public enum FUNCTION implements Serializable {
        JUNK_FILES(1, R.drawable.ic_vector_clean, R.string.junk_files, R.string.junk, R.string.junk_files_des, R.drawable.bg_func_junkfile, R.color.black, R.string.clean, "trash_result.json", R.string.clean_result, R.string.junk_files_btn, R.string.junk_files_dialog);
...
//        }
    ...
    public static final FUNCTION[] LST_HOME_HORIZONTAL = new FUNCTION[]{
            FUNCTION.JUNK_FILES
        //FUNCTION.PHONE_BOOST, FUNCTION.CPU_COOLER, FUNCTION.ANTIVIRUS, FUNCTION.POWER_SAVING, FUNCTION.DEEP_CLEAN
    };
...
//            FUNCTION.ADDITIONAL_SPEED
    ...
    public static FUNCTION getFunctionById(int id) {
        for (FUNCTION mFunction : FUNCTION.values()) {
            if (mFunction.id == id)
                return mFunction;
        }
        return null;
