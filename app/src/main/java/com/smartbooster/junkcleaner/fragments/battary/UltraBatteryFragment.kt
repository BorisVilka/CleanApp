...
import kotlinx.android.synthetic.main.fragment_ultra_battery.*
...
class UltraBatteryFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    return inflater.inflate(R.layout.fragment_ultra_battery, container, false)
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    Thread {
      while (status < 100) {
        ...
        handler.post {
          battery_percent_ultra.text = status.toString() + "%"
          if (status == 50) {
            analizing_text_ultra.text = "Optimizing..."

          }
          if (status == 100) {

            lottie_battery_ultra.visibility = View.GONE

            lottie_battery_done_ultra.visibility = View.VISIBLE
    ...
    lottie_battery_done_ultra.addAnimatorListener(object : Animator.AnimatorListener {
